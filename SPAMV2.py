...
os.system("termux-open-url  https://www.youtube.com/channel/UChGL-Wh1T2VtAgMG9MTt5UQ ")
banner = """
\033[1;35m  
╔╦╦╦═╦╗╔═╦═╦══╦═╗
║║║║╩╣╚╣═╣║║║║║╩╣
╚══╩═╩═╩═╩═╩╩╩╩═╝
≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈»
\033[1;32mSEBUT SAYA : MIKUXXX
DLCXWWWSADD BACOT KNTL: MIKUIQ
SEBUT SEKALI LAGI: MIKUXXX

IQPRODUCTION -_X-sww××××× Hidup Seperti Lary
 🥺
...
while True:
	try:
		a=input("MASUKIN NOMORNYA BLOK :  ")
		asu=a[0:2]
		if a in(""," "):print("MASUKIN NOMOR GOBLOK , DAH DIBILANGIN JUGA")
		elif "08" not in asu:print("Capek Gue Sama Lu , AWALNYA 0 KONTOL")
		elif len(a)<=10:print("MIKIR PAKE OTAK BABI , NOMOR HP TU LEBIH DARI 9")
		else:
			b=a[1:12] 
			c="62"+b
			nyepam(b,a,c).mulai()
